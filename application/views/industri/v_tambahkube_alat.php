...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <link href="<?php echo base_url('assets/datatables/css/dataTables.bootstrap.min.css')?>" rel="stylesheet">
        ...
        <title>Data Tambah Bantuan Peralatan</title>
...
<main id="main-container">
    <div class="container"><br>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table>
                    <tr>               
                    <?php echo form_open('industri/kube/refreshlagi') ?>
              ...
              ?>
                <tr>
                  ...
                  <td style="text-align:center;">
                        <a href="javascript:void(0);" class="btn btn-xs btn-info btn-edit" data-idbantuan="<?php echo $row->ID_BANTUAN;?>" data-idkube="<?php echo $idkube;?>" data-nama="<?php echo $row->NAMA;?>">
    ...
    <!-- ============ CLOSE TABEL CARI=============== -->  
        ...
        <!-- Modal Add Product-->
        <form action="<?php echo base_url().'industri/kube/tambah_dataalat'?>" method="post">
                    ...
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                             <div class="form-group">
                                <input type="text" name="xnama" class="form-control" placeholder="Nama Alat" readonly>
                            </div>
                            <div class="form-group">
