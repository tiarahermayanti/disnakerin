...
<main id="main-container">
    <div class="container"><br>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table>
                    <tr>               
                    <?php echo form_open('industri/bantuanalat/refresh') ?>
              ...
              ?>
                <tr>
                  ...
                  <td style="text-align:center;">
                        <a href="javascript:void(0);" class="btn btn-xs btn-info btn-edit" data-idbantuan="<?php echo $idbantuan;?>" data-idkube="<?php echo $row->ID_KUB;?>" data-nama="<?php echo $row->NAMA_KUB;?>">
    ...
    <!-- ============ CLOSE TABEL CARI=============== -->  
        ...
        <!-- Modal Add Product-->
        <form action="<?php echo base_url().'industri/bantuanalat/tambah_datakub'?>" method="post">
                    ...
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <div class="form-group">
                                <input type="text" name="xnama" class="form-control" placeholder="Nama Kube" readonly>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xmerk" class="form-control" placeholder="Merk Peralatan" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xjumlah" class="form-control" placeholder="Jumlah Bantuan Peralatan" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xtahun" class="form-control" placeholder="Tahun" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xketerangan" class="form-control" placeholder="Keterangan" required>
                            </div>
                            
                            <input type="hidden" name="idbantuan" class="form-control">
                            <input type="hidden" name="keyword" value="<?php echo $keyword;?>">
                            <input type="hidden" name="idkube" class="form-control">
    ...
    <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('.btn-edit').on('click',function(){
                    ...
                    var idkube=$(this).data('idkube');
                    $('#ModalUpdate').modal('show');
                    $('[name="idbantuan"]').val(idbantuan);
                    $('[name="xnama"]').val(nama);
                    $('[name="idkube"]').val(idkube);
                });
