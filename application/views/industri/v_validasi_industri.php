                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Validasi Industri</h3>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row->TELP;?></td>
                                                 <td><?php echo $row->BENTUK_USAHA;?></td>

                                                <td style="width: 90px;text-align: center;">
                                                   <!--  <a href="dataindustri/info/$1" class="btn btn-info" data-id="<?php echo $row->ID_IKM;?>"><span class="fa fa-search"></span></a> -->

                                                    <a href="infoValid/<?php echo $row->ID_IKM;?>" class="btn btn-info" ><span class="fa fa-search"></span></a> 

                                                    <a href="valid/<?php echo $row->ID_IKM;?>" class="btn btn-info" style="background: #00DD49" ><span class ="fa fa-check"></span></a>

                                                    <a href="javascript:void(0);" class="btn btn-info" style="background: #FF0000;" data-id="<?php echo $row->ID_IKM;?>"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
                                        </tbody>
