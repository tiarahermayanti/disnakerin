...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <link href="<?php echo base_url('assets/datatables/css/dataTables.bootstrap.min.css')?>" rel="stylesheet">
        ...
        <title>Rekap Pelatihan & Fasilitas yang Diterima Industri </title>
...
<main id="main-container">
    <div class="container"><br>
            <h2>Rekap Pelatihan & Fasilitas yang Diterima Industri</h2>
        <br>
    ...
    $(document).ready(function(){
      ...
      var table = $("#mytable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'industri/dataindustri/get_rekapindustripelatihan_json'?>", "type": "POST"},
                    columns: [
                                {"data": "ID_IKM"},
