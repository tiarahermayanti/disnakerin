...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <link href="<?php echo base_url('assets/datatables/css/dataTables.bootstrap.min.css')?>" rel="stylesheet">
        ...
        <title>Data Bantuan Peralatan</title>
...
<main id="main-container">
    ...
    <table class="table table-striped" id="mytable">
      <thead>
        ...
        <!-- Modal Add Product-->
      <form id="add-row-form" action="<?php echo site_url('industri/bantuanalat/save');?>" method="post">
               ...
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                        <div class="form-group">
                           <input type="text" name="NAMA" class="form-control" placeholder="Nama Peralatan" required>
                       </div> 
                   </div>
     ...
     <!-- Modal Update Product-->
      <form id="add-row-form" action="<?php echo site_url('industri/bantuanalat/update');?>" method="post">
     ...
     <!-- Modal delete Product-->
      <form id="add-row-form" action="<?php echo site_url('industri/bantuanalat/delete');?>" method="post">
    ...
    $(document).ready(function(){
      ...
      var table = $("#mytable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'industri/bantuanalat/get_bantuanalat_json'?>", "type": "POST"},
                    columns: [
                        {"data": "ID_BANTUAN"},
                        {"data": "NAMA"},
                        {"data": "view"}
