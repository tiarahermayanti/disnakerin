...
<main id="main-container">
    <div class="container"><br>
            <h2>Data Anggota Pelatihan dan Fasilitas</h2>
            <?php 
            $idpelatihan=$b['ID_BANTUAN'];
            ;?>
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <?php echo form_open('industri/datapelatihan/search') ?>
            ...
            <table id="mytable" class="table table-striped">
              <thead>
                ...
                <tbody>
                  <?php 
                    $no=0;
                    foreach ($datalatih->result() as $row) :
                    $no++;
                  ?>
                <tr>
                  <td><?php echo $no;?></td>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'industri/datapelatihan/hapus_datalatih'?>" method="post">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            ...
                            <input type="hidden" name="idpelatihan" id="idpelatihan" required><input type="hidden" name="kode" id="kode" required>
                        </div>
                    </div>
