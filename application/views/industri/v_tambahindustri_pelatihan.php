...
<main id="main-container">
    <div class="container"><br>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table>
                    <tr>               
                    <?php echo form_open('industri/datapelatihan/refresh') ?>
                    <input type="hidden" name="idpelatihan" value="<?php echo $idpelatihan;?>">
              ...
              ?>
                <tr>
                  ...
                  <td style="text-align:center;">
                        <a href="javascript:void(0);" class="btn btn-xs btn-info btn-edit" data-idbantuan="<?php echo $idpelatihan;?>" data-idikm="<?php echo $row->ID_IKM;?>" data-nama="<?php echo $row->NAMA_PERUSAHAAN;?>">
    ...
    <!-- ============ CLOSE TABEL CARI=============== -->  
        ...
        <!-- Modal Add Product-->
        <form action="<?php echo base_url().'industri/datapelatihan/tambah_dataindustri'?>" method="post">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Tambah Data Industri</h3>
                        ...
                        <div class="block-content">
                             ...
                             <div class="form-group">
                                <input type="text" name="xnama" class="form-control" placeholder="Nama Industri" readonly>
                            </div>
                            <div class="form-group">
                                <input type="text" name="xtahun" class="form-control" placeholder="Tahun" required>
                            </div>
                            <input type="hidden" name="idpelatihan" class="form-control">
                            <input type="hidden" name="keyword" value="<?php echo $keyword;?>">
                            <input type="hidden" name="idikm" class="form-control">
    ...
    <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('.btn-edit').on('click',function(){
                    ...
                    $('[name="idpelatihan"]').val(idbantuan);
                    $('[name="xnama"]').val(nama);
                    $('[name="idikm"]').val(idikm);
                });
