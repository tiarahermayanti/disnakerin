...
<main id="main-container">
    <div class="container"><br>
            <h2>Data Peralatan yang Diterima Kube</h2>
            <?php 
            $idkube=$b['ID_KUB'];
            ;?>
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <?php echo form_open('industri/kube/cari') ?>
              <input type="hidden" name="idkube" value="<?php echo $idkube;?>">
              <input type="text" name="keyword" placeholder="search">
              <input type="submit" name="search_submit" value="Cari Peralatan">
            <?php echo form_close() ?> 
          </div>
        </div>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'industri/kube/hapus_dataalat'?>" method="post">
