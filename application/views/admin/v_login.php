                        ...
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                <p class="font-size-h3 font-w600 text-white">
                                    Pemerintah Kota Padang <br> Dinas Tenaga Kerja dan Perindustrian
                                </p>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="<?php echo base_url();?>">
                                        <i class=""></i>
                                        <span class="font-size-xl text-success"> Dinas Tenaga Kerja dan Perindustrian</span><span class="font-size-xl text-primary-dark"> Kota Padang</span>
                                    </a>
