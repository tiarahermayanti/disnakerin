...
class Googlemaps{
	...
	var $apiKey						= 'AIzaSyDcG5b6BWzuhCUk7544FgmnSeSqfDTqBS0'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
