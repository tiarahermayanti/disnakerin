...
class Administrator extends CI_Controller{
    ...
    function auth(){
        ...
        if($this->session->userdata('masuk')==true and $xcadmin['pengguna_level']=='1' ){
            redirect('administrator/berhasillogin');
        }elseif($this->session->userdata('masuk')==true || $xcadmin['pengguna_level']=='2' ){
            redirect('administrator/berhasilloginindustri');    
        }else{
        ...
        function berhasilloginindustri(){
            redirect('industri/dashboard');
        }
        function gagallogin(){
